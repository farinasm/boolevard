...
html_logo = 'https://raw.githubusercontent.com/farinasm/boolevard/main/docs/Logo_white.png'
html_favicon = 'https://raw.githubusercontent.com/farinasm/boolevard/main/docs/icon.png'
html_theme_options = {
    "logo_only": True,
